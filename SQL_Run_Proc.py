...
import pandas as pd
import os
from openingZippedFile import open_zippedCSV_as_DataFrame
from Parameters import connection_string, fico_results_archive, scenario_name


def execute_sql_proc(cut, band, iteration, ISC_path, lanes=True):
    ...
    if lanes:
        lane_products = open_zippedCSV_as_DataFrame(ISC_path,delete_zip=True)
